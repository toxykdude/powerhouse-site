...
- [x] **4.2** Modify `src/layouts/Base.astro`: add to `pageNames` (L45–52): `'entrenadores':'Entrenadores'`, `'harold-giraldo':'Harold Giraldo'`, `'esteban-morales':'Esteban Morales'`, `'brayan-molina':'Brayan Molina'`.
